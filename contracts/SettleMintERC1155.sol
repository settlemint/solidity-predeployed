...
/// @dev Extends ERC1155 with burnable, and supply tracking functionalities. IMPORTANT: This contract does not have any authorization mechanism. It is intended to be used as a basic token for testing or development purposes.
/// @custom:security-contact support@settlemint.com
contract SettleMintERC1155 is ERC1155, ERC1155Burnable, ERC1155Supply {
    /// @dev Constructor that initializes the contract with an empty URI
    constructor() ERC1155("") { }
